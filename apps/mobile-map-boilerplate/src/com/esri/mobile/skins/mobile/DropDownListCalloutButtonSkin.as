...
public class DropDownListCalloutButtonSkin extends com.esri.mobile.skins.mobile.supportClasses.ButtonSkinBase
{
    ...
    [Embed(source="../mobile160/assets/spinner_normal_holo_light.png", scaleGridTop="6", scaleGridLeft="4", scaleGridBottom="15", scaleGridRight="5")]
    private static const button_up_160:Class;

    [Embed(source="../mobile160/assets/spinner_pressed_holo_light.png", scaleGridTop="6", scaleGridLeft="4", scaleGridBottom="15", scaleGridRight="5")]
     ...
     *
     */
    public function DropDownListCalloutButtonSkin()
    {
        super();
